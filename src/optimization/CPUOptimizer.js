...
export class CPUOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CPUOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CPUOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CPUOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CPUOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CPUOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CPUOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CPUOptimizer error:`, error);
    }
  }
