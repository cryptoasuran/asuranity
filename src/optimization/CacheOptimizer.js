...
export class CacheOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CacheOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CacheOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CacheOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CacheOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CacheOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CacheOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CacheOptimizer error:`, error);
    }
  }
