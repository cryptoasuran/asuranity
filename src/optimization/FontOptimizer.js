...
export class FontOptimizer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('FontOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`FontOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`FontOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`FontOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`FontOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`FontOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`FontOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new FontOptimizer(options);
  }
}
