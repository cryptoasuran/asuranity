...
export class StreamOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StreamOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StreamOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StreamOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StreamOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StreamOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StreamOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StreamOptimizer error:`, error);
    }
  }
