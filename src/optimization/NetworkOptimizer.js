...
export class NetworkOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('NetworkOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`NetworkOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`NetworkOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`NetworkOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`NetworkOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`NetworkOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`NetworkOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new NetworkOptimizer(options);
  }
}
