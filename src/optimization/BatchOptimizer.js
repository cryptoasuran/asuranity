...
export class BatchOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('BatchOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`BatchOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`BatchOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`BatchOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`BatchOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`BatchOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`BatchOptimizer error:`, error);
    }
  }
