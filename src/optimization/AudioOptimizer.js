...
export class AudioOptimizer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('AudioOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`AudioOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`AudioOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`AudioOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`AudioOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`AudioOptimizer resumed`);
    }
  }
