...
export class StorageOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StorageOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StorageOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StorageOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StorageOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StorageOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StorageOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StorageOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new StorageOptimizer(options);
  }
}
