...
export class ImageOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ImageOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ImageOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ImageOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ImageOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ImageOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ImageOptimizer resumed`);
    }
  }
