...
export class AssetOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('AssetOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`AssetOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`AssetOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`AssetOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`AssetOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`AssetOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`AssetOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new AssetOptimizer(options);
  }
}
