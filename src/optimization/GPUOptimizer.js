...
export class GPUOptimizer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('GPUOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`GPUOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`GPUOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`GPUOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`GPUOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`GPUOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`GPUOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new GPUOptimizer(options);
  }
}
