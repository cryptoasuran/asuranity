...
export class PipelineOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PipelineOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PipelineOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PipelineOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PipelineOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PipelineOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PipelineOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PipelineOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new PipelineOptimizer(options);
  }
}
