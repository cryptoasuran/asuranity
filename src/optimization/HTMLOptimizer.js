...
export class HTMLOptimizer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('HTMLOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`HTMLOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`HTMLOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`HTMLOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`HTMLOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`HTMLOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`HTMLOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new HTMLOptimizer(options);
  }
}
