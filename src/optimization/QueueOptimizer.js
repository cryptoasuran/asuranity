...
export class QueueOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('QueueOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`QueueOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`QueueOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`QueueOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`QueueOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`QueueOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`QueueOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new QueueOptimizer(options);
  }
}
