...
export class SigningOptimizer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('SigningOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`SigningOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`SigningOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`SigningOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`SigningOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`SigningOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`SigningOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new SigningOptimizer(options);
  }
}

export default SigningOptimizer;
