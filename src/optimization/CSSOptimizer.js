...
export class CSSOptimizer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CSSOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CSSOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CSSOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CSSOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CSSOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CSSOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CSSOptimizer error:`, error);
    }
  }
  ...
  static create(options) {
    return new CSSOptimizer(options);
  }
}
