...
export class MemoryOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('MemoryOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`MemoryOptimizer setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`MemoryOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`MemoryOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`MemoryOptimizer error:`, error);
    }
  }
