...
export class BundleOptimizer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('BundleOptimizer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`BundleOptimizer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`BundleOptimizer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`BundleOptimizer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`BundleOptimizer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`BundleOptimizer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`BundleOptimizer error:`, error);
    }
  }
