...
export class SignerUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('SignerUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`SignerUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`SignerUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`SignerUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`SignerUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`SignerUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`SignerUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new SignerUtils(options);
  }
}
