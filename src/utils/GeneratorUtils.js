...
export class GeneratorUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('GeneratorUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`GeneratorUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`GeneratorUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`GeneratorUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`GeneratorUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`GeneratorUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`GeneratorUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new GeneratorUtils(options);
  }
}
