...
export class StringUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StringUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StringUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StringUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StringUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StringUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StringUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StringUtils error:`, error);
    }
  }
