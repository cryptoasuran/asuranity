...
export class FormatterUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('FormatterUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`FormatterUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`FormatterUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`FormatterUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`FormatterUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`FormatterUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`FormatterUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new FormatterUtils(options);
  }
}
