...
export class RegistryUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RegistryUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RegistryUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RegistryUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RegistryUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RegistryUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RegistryUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RegistryUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new RegistryUtils(options);
  }
}
