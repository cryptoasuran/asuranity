...
export class CompressorUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CompressorUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CompressorUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CompressorUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CompressorUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CompressorUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CompressorUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CompressorUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new CompressorUtils(options);
  }
}

export default CompressorUtils;
