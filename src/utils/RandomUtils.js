...
export class RandomUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RandomUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RandomUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RandomUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RandomUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RandomUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RandomUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RandomUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new RandomUtils(options);
  }
}
