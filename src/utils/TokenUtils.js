...
export class TokenUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TokenUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TokenUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TokenUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`TokenUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`TokenUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`TokenUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TokenUtils error:`, error);
    }
  }
