...
export class ArrayUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ArrayUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ArrayUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ArrayUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ArrayUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ArrayUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ArrayUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ArrayUtils error:`, error);
    }
  }
