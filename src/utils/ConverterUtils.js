...
export class ConverterUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ConverterUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ConverterUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ConverterUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ConverterUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ConverterUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ConverterUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ConverterUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new ConverterUtils(options);
  }
}
