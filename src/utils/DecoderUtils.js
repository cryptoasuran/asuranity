...
export class DecoderUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('DecoderUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`DecoderUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`DecoderUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`DecoderUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`DecoderUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`DecoderUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`DecoderUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new DecoderUtils(options);
  }
}
