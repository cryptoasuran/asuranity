...
export class RoleUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RoleUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RoleUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RoleUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RoleUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RoleUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RoleUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RoleUtils error:`, error);
    }
  }
