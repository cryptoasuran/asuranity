...
export class CacheUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CacheUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CacheUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CacheUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CacheUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CacheUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CacheUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CacheUtils error:`, error);
    }
  }
