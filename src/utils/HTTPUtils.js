...
export class HTTPUtils extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('HTTPUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`HTTPUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`HTTPUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`HTTPUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`HTTPUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`HTTPUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`HTTPUtils error:`, error);
    }
  }
