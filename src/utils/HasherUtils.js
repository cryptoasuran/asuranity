...
export class HasherUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('HasherUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`HasherUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`HasherUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`HasherUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`HasherUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`HasherUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`HasherUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new HasherUtils(options);
  }
}

export default HasherUtils;
