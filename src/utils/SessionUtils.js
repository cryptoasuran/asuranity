...
export class SessionUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('SessionUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`SessionUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`SessionUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`SessionUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`SessionUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`SessionUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`SessionUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new SessionUtils(options);
  }
}
