...
export class QueryUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('QueryUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`QueryUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`QueryUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`QueryUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`QueryUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`QueryUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`QueryUtils error:`, error);
    }
  }
