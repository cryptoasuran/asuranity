...
export class SerializerUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('SerializerUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`SerializerUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`SerializerUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`SerializerUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`SerializerUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`SerializerUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`SerializerUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new SerializerUtils(options);
  }
}
