...
export class FileUtils extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('FileUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`FileUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`FileUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`FileUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`FileUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`FileUtils resumed`);
    }
  }
