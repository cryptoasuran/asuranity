...
export class StreamUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StreamUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StreamUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StreamUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StreamUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StreamUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StreamUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StreamUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new StreamUtils(options);
  }
}
