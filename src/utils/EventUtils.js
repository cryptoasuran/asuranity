...
export class EventUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('EventUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`EventUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`EventUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`EventUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`EventUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`EventUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`EventUtils error:`, error);
    }
  }
