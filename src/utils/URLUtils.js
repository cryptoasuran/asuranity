...
export class URLUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('URLUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`URLUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`URLUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`URLUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`URLUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`URLUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`URLUtils error:`, error);
    }
  }
