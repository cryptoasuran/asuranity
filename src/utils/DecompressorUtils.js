...
export class DecompressorUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('DecompressorUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`DecompressorUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`DecompressorUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`DecompressorUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`DecompressorUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`DecompressorUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`DecompressorUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new DecompressorUtils(options);
  }
}

export default DecompressorUtils;
