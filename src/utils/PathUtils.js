...
export class PathUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PathUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PathUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PathUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PathUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PathUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PathUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PathUtils error:`, error);
    }
  }
