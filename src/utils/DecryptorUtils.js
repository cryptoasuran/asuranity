...
export class DecryptorUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('DecryptorUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`DecryptorUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`DecryptorUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`DecryptorUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`DecryptorUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`DecryptorUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`DecryptorUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new DecryptorUtils(options);
  }
}

export default DecryptorUtils;
