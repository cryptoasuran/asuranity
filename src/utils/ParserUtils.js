...
export class ParserUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ParserUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ParserUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ParserUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ParserUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ParserUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ParserUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ParserUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new ParserUtils(options);
  }
}
