...
export class PoolUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PoolUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PoolUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PoolUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PoolUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PoolUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PoolUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PoolUtils error:`, error);
    }
  }
