...
export class JWTUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('JWTUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`JWTUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`JWTUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`JWTUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`JWTUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`JWTUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`JWTUtils error:`, error);
    }
  }
