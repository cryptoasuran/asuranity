...
export class BufferUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('BufferUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`BufferUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`BufferUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`BufferUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`BufferUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`BufferUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`BufferUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new BufferUtils(options);
  }
}
