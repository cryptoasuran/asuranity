...
export class TimeUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TimeUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TimeUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TimeUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`TimeUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`TimeUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`TimeUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TimeUtils error:`, error);
    }
  }
