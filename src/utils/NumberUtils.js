...
export class NumberUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('NumberUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`NumberUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`NumberUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`NumberUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`NumberUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`NumberUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`NumberUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new NumberUtils(options);
  }
}
