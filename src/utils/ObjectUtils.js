...
export class ObjectUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ObjectUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ObjectUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ObjectUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ObjectUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ObjectUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ObjectUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ObjectUtils error:`, error);
    }
  }
