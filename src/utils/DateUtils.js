...
export class DateUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('DateUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`DateUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`DateUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`DateUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`DateUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`DateUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`DateUtils error:`, error);
    }
  }
