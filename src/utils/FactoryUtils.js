...
export class FactoryUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('FactoryUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`FactoryUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`FactoryUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`FactoryUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`FactoryUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`FactoryUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`FactoryUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new FactoryUtils(options);
  }
}
