...
export class PermissionUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PermissionUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PermissionUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PermissionUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PermissionUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PermissionUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PermissionUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PermissionUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new PermissionUtils(options);
  }
}
