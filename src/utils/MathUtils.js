...
export class MathUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('MathUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`MathUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`MathUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`MathUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`MathUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`MathUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`MathUtils error:`, error);
    }
  }
