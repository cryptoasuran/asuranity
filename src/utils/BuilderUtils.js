...
export class BuilderUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('BuilderUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`BuilderUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`BuilderUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`BuilderUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`BuilderUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`BuilderUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`BuilderUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new BuilderUtils(options);
  }
}
