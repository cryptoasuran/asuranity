...
export class DeserializerUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('DeserializerUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`DeserializerUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`DeserializerUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`DeserializerUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`DeserializerUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`DeserializerUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`DeserializerUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new DeserializerUtils(options);
  }
}
