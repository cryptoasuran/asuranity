...
export class NetworkUtils extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('NetworkUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`NetworkUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`NetworkUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`NetworkUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`NetworkUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`NetworkUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`NetworkUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new NetworkUtils(options);
  }
}
