...
export class AuthUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('AuthUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`AuthUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`AuthUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`AuthUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`AuthUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`AuthUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`AuthUtils error:`, error);
    }
  }
