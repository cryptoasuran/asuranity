...
export class StateUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StateUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StateUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StateUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StateUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StateUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StateUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StateUtils error:`, error);
    }
  }
