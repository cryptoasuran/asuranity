...
export class EncoderUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('EncoderUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`EncoderUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`EncoderUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`EncoderUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`EncoderUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`EncoderUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`EncoderUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new EncoderUtils(options);
  }
}
