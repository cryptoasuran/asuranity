...
export class ValidationUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ValidationUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ValidationUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ValidationUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ValidationUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ValidationUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ValidationUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ValidationUtils error:`, error);
    }
  }
