...
export class WebSocketUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('WebSocketUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`WebSocketUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`WebSocketUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`WebSocketUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`WebSocketUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`WebSocketUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`WebSocketUtils error:`, error);
    }
  }
  ...
  static create(options) {
    return new WebSocketUtils(options);
  }
}
