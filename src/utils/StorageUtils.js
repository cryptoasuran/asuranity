...
export class StorageUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StorageUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StorageUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StorageUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StorageUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StorageUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StorageUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StorageUtils error:`, error);
    }
  }
