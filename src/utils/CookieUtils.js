...
export class CookieUtils extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CookieUtils already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CookieUtils setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CookieUtils started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CookieUtils stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CookieUtils paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CookieUtils resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CookieUtils error:`, error);
    }
  }
