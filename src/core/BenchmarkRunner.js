...
export class BenchmarkRunner extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('BenchmarkRunner already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`BenchmarkRunner setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`BenchmarkRunner started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`BenchmarkRunner stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`BenchmarkRunner paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`BenchmarkRunner resumed`);
    }
  }
