...
export class TelemetryCollector extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TelemetryCollector already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TelemetryCollector setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TelemetryCollector started`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TelemetryCollector error:`, error);
    }
  }
