...
export class ServiceWorkerManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ServiceWorkerManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ServiceWorkerManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ServiceWorkerManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ServiceWorkerManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ServiceWorkerManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ServiceWorkerManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ServiceWorkerManager error:`, error);
    }
  }
