...
export class TracingManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TracingManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TracingManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TracingManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`TracingManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`TracingManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`TracingManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TracingManager error:`, error);
    }
  }
