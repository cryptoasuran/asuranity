...
export class PriorityQueue extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PriorityQueue already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PriorityQueue setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PriorityQueue started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PriorityQueue stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PriorityQueue paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PriorityQueue resumed`);
    }
  }
