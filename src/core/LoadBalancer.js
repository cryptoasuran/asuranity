...
export class LoadBalancer extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('LoadBalancer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`LoadBalancer setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`LoadBalancer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`LoadBalancer resumed`);
    }
  }
