...
export class ThemeManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ThemeManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ThemeManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ThemeManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ThemeManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ThemeManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ThemeManager resumed`);
    }
  }
