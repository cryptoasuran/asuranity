...
export class MetricsAggregator extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('MetricsAggregator already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`MetricsAggregator setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`MetricsAggregator paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`MetricsAggregator resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`MetricsAggregator error:`, error);
    }
  }
