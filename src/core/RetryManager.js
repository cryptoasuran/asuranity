...
export class RetryManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RetryManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RetryManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RetryManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RetryManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RetryManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RetryManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RetryManager error:`, error);
    }
  }
