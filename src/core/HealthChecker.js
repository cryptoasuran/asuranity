...
export class HealthChecker extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('HealthChecker already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`HealthChecker setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`HealthChecker paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`HealthChecker resumed`);
    }
  }
