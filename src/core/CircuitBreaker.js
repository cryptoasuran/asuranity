...
export class CircuitBreaker extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CircuitBreaker already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CircuitBreaker setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CircuitBreaker started`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`CircuitBreaker paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CircuitBreaker resumed`);
    }
  }
