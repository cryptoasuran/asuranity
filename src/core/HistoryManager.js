...
export class HistoryManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('HistoryManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`HistoryManager setup complete`);
    }
  }
  ...
  handleStop() {
    if (this.options.debug) {
      console.log(`HistoryManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`HistoryManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`HistoryManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`HistoryManager error:`, error);
    }
  }
