...
export class IndexedDBManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('IndexedDBManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`IndexedDBManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`IndexedDBManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`IndexedDBManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`IndexedDBManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`IndexedDBManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`IndexedDBManager error:`, error);
    }
  }
  ...
  static create(options) {
    return new IndexedDBManager(options);
  }
}
