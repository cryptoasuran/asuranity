...
export class WebGPUManager extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('WebGPUManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`WebGPUManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`WebGPUManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`WebGPUManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`WebGPUManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`WebGPUManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`WebGPUManager error:`, error);
    }
  }
  ...
  static create(options) {
    return new WebGPUManager(options);
  }
}
