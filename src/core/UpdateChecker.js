...
export class UpdateChecker extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('UpdateChecker already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`UpdateChecker setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`UpdateChecker started`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`UpdateChecker paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`UpdateChecker resumed`);
    }
  }
