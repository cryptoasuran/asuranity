...
export class CPUMonitor extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CPUMonitor already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CPUMonitor setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CPUMonitor started`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`CPUMonitor paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CPUMonitor resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CPUMonitor error:`, error);
    }
  }
