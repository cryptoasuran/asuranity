...
export class CrashReporter extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('CrashReporter already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CrashReporter setup complete`);
    }
  }
  ...
  handleStop() {
    if (this.options.debug) {
      console.log(`CrashReporter stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CrashReporter paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CrashReporter resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`CrashReporter error:`, error);
    }
  }
