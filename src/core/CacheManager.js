...
export class CacheManager extends EventEmitter {
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`CacheManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`CacheManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`CacheManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`CacheManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`CacheManager resumed`);
    }
  }
