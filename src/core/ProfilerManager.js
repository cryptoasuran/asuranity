...
export class ProfilerManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ProfilerManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ProfilerManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ProfilerManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ProfilerManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ProfilerManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ProfilerManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ProfilerManager error:`, error);
    }
  }
