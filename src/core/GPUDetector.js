...
export class GPUDetector extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('GPUDetector already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`GPUDetector setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`GPUDetector started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`GPUDetector stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`GPUDetector paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`GPUDetector resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`GPUDetector error:`, error);
    }
  }
  ...
  static create(options) {
    return new GPUDetector(options);
  }
}
