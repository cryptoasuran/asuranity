...
export class TimeoutManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TimeoutManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TimeoutManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TimeoutManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`TimeoutManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`TimeoutManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`TimeoutManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TimeoutManager error:`, error);
    }
  }
