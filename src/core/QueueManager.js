...
export class QueueManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('QueueManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`QueueManager setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`QueueManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`QueueManager resumed`);
    }
  }
