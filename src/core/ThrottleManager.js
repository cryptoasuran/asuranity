...
export class ThrottleManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ThrottleManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ThrottleManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ThrottleManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ThrottleManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ThrottleManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ThrottleManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ThrottleManager error:`, error);
    }
  }
  ...
  static create(options) {
    return new ThrottleManager(options);
  }
}
