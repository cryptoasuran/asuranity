...
export class MemoryManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('MemoryManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`MemoryManager setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`MemoryManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`MemoryManager resumed`);
    }
  }
