...
export class BackupManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('BackupManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`BackupManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`BackupManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`BackupManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`BackupManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`BackupManager resumed`);
    }
  }
