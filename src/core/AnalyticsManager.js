...
export class AnalyticsManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('AnalyticsManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`AnalyticsManager setup complete`);
    }
  }
  ...
  handleStop() {
    if (this.options.debug) {
      console.log(`AnalyticsManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`AnalyticsManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`AnalyticsManager resumed`);
    }
  }
