...
export class PreferenceManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PreferenceManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PreferenceManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PreferenceManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PreferenceManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PreferenceManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PreferenceManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PreferenceManager error:`, error);
    }
  }
  ...
  static create(options) {
    return new PreferenceManager(options);
  }
}
