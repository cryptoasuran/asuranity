...
export class StatisticsCollector extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('StatisticsCollector already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`StatisticsCollector setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`StatisticsCollector started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`StatisticsCollector stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`StatisticsCollector paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`StatisticsCollector resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`StatisticsCollector error:`, error);
    }
  }
  ...
  static create(options) {
    return new StatisticsCollector(options);
  }
}
