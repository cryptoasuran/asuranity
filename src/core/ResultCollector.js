...
export class ResultCollector extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ResultCollector already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ResultCollector setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ResultCollector started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ResultCollector stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ResultCollector paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ResultCollector resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ResultCollector error:`, error);
    }
  }
