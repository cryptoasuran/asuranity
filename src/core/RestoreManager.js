...
export class RestoreManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RestoreManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RestoreManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RestoreManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RestoreManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RestoreManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RestoreManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RestoreManager error:`, error);
    }
  }
  ...
  static create(options) {
    return new RestoreManager(options);
  }
}
