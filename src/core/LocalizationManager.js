...
export class LocalizationManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('LocalizationManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`LocalizationManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`LocalizationManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`LocalizationManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`LocalizationManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`LocalizationManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`LocalizationManager error:`, error);
    }
  }
  ...
  static create(options) {
    return new LocalizationManager(options);
  }
}
