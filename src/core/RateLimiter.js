...
export class RateLimiter extends EventEmitter {
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RateLimiter setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RateLimiter started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RateLimiter stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RateLimiter paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RateLimiter resumed`);
    }
  }
