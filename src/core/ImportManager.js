...
export class ImportManager extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ImportManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ImportManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ImportManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ImportManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ImportManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ImportManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ImportManager error:`, error);
    }
  }
