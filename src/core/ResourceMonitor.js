...
export class ResourceMonitor extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ResourceMonitor already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ResourceMonitor setup complete`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`ResourceMonitor paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ResourceMonitor resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ResourceMonitor error:`, error);
    }
  }
