...
export class MigrationManager extends EventEmitter {
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`MigrationManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`MigrationManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`MigrationManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`MigrationManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`MigrationManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`MigrationManager error:`, error);
    }
  }
