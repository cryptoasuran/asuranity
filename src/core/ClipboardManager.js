...
export class ClipboardManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ClipboardManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ClipboardManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ClipboardManager started`);
    }
  }
  ...
  handlePause() {
    if (this.options.debug) {
      console.log(`ClipboardManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ClipboardManager resumed`);
    }
  }
