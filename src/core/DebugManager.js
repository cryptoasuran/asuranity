...
export class DebugManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('DebugManager already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`DebugManager setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`DebugManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`DebugManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`DebugManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`DebugManager resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`DebugManager error:`, error);
    }
  }
