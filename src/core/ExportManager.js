...
export class ExportManager extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ExportManager already initialized');
    }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ExportManager started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ExportManager stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ExportManager paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ExportManager resumed`);
    }
  }
