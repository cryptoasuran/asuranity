...
export class PatternMapper extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternMapper already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternMapper setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternMapper started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternMapper stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternMapper paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternMapper resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternMapper error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternMapper(options);
  }
}
