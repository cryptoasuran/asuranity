...
export class PatternExtractor extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternExtractor already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternExtractor setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternExtractor started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternExtractor stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternExtractor paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternExtractor resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternExtractor error:`, error);
    }
  }
