...
export class EmailMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('EmailMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`EmailMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`EmailMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`EmailMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`EmailMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`EmailMatcher resumed`);
    }
  }
  ...
  static create(options) {
    return new EmailMatcher(options);
  }
}
