...
export class PathMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PathMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PathMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PathMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PathMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PathMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PathMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PathMatcher error:`, error);
    }
  }
