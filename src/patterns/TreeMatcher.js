...
export class TreeMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TreeMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TreeMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TreeMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`TreeMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`TreeMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`TreeMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TreeMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new TreeMatcher(options);
  }
}
