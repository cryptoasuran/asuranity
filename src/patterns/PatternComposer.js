...
export class PatternComposer extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternComposer already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternComposer setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternComposer started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternComposer stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternComposer paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternComposer resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternComposer error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternComposer(options);
  }
}

export default PatternComposer;
