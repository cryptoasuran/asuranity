...
export class EntityMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('EntityMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`EntityMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`EntityMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`EntityMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`EntityMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`EntityMatcher resumed`);
    }
  }
  ...
  static create(options) {
    return new EntityMatcher(options);
  }
}
