...
export class KeywordMatcher extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('KeywordMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`KeywordMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`KeywordMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`KeywordMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`KeywordMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`KeywordMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`KeywordMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new KeywordMatcher(options);
  }
}
