...
export class RangeMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RangeMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RangeMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RangeMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RangeMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RangeMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RangeMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RangeMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new RangeMatcher(options);
  }
}

export default RangeMatcher;
