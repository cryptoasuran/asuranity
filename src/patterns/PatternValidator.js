...
export class PatternValidator extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternValidator already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternValidator setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternValidator started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternValidator stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternValidator paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternValidator resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternValidator error:`, error);
    }
  }
