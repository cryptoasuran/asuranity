...
export class PatternInjector extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternInjector already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternInjector setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternInjector started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternInjector stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternInjector paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternInjector resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternInjector error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternInjector(options);
  }
}

export default PatternInjector;
