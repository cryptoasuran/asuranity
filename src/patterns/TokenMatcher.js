...
export class TokenMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('TokenMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`TokenMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`TokenMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`TokenMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`TokenMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`TokenMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`TokenMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new TokenMatcher(options);
  }
}
