...
export class ContainsMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ContainsMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ContainsMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ContainsMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ContainsMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ContainsMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ContainsMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ContainsMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new ContainsMatcher(options);
  }
}

export default ContainsMatcher;
