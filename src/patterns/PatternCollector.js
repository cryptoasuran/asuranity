...
export class PatternCollector extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternCollector already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternCollector setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternCollector started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternCollector stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternCollector paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternCollector resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternCollector error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternCollector(options);
  }
}

export default PatternCollector;
