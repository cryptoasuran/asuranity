...
export class UUIDMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('UUIDMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`UUIDMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`UUIDMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`UUIDMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`UUIDMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`UUIDMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`UUIDMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new UUIDMatcher(options);
  }
}
