...
export class PatternMerger extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternMerger already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternMerger setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternMerger started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternMerger stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternMerger paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternMerger resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternMerger error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternMerger(options);
  }
}

export default PatternMerger;
