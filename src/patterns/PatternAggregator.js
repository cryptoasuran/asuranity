...
export class PatternAggregator extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternAggregator already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternAggregator setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternAggregator started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternAggregator stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternAggregator paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternAggregator resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternAggregator error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternAggregator(options);
  }
}
