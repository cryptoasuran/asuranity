...
export class ChecksumMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ChecksumMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ChecksumMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ChecksumMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ChecksumMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ChecksumMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ChecksumMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ChecksumMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new ChecksumMatcher(options);
  }
}

export default ChecksumMatcher;
