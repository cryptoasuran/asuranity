...
export class URLMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('URLMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`URLMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`URLMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`URLMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`URLMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`URLMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`URLMatcher error:`, error);
    }
  }
