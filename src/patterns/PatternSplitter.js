...
export class PatternSplitter extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternSplitter already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternSplitter setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternSplitter started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternSplitter stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternSplitter paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternSplitter resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternSplitter error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternSplitter(options);
  }
}

export default PatternSplitter;
