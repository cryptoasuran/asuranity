...
export class RegexMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RegexMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RegexMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RegexMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RegexMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RegexMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RegexMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RegexMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new RegexMatcher(options);
  }
}
