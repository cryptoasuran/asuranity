...
export class HashMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('HashMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`HashMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`HashMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`HashMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`HashMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`HashMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`HashMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new HashMatcher(options);
  }
}

export default HashMatcher;
