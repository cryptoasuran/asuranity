...
export class PatternAdapter extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternAdapter already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternAdapter setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternAdapter started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternAdapter stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternAdapter paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternAdapter resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PatternAdapter error:`, error);
    }
  }
  ...
  static create(options) {
    return new PatternAdapter(options);
  }
}
