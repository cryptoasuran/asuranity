...
export class IPMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('IPMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`IPMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`IPMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`IPMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`IPMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`IPMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`IPMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new IPMatcher(options);
  }
}

export default IPMatcher;
