...
export class FuzzyMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('FuzzyMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`FuzzyMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`FuzzyMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`FuzzyMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`FuzzyMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`FuzzyMatcher resumed`);
    }
  }
  ...
  static create(options) {
    return new FuzzyMatcher(options);
  }
}
