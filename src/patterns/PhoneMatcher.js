...
export class PhoneMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PhoneMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PhoneMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PhoneMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PhoneMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PhoneMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PhoneMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PhoneMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new PhoneMatcher(options);
  }
}

export default PhoneMatcher;
