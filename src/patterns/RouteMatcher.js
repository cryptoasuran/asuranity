...
export class RouteMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('RouteMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`RouteMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`RouteMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`RouteMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`RouteMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`RouteMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`RouteMatcher error:`, error);
    }
  }
