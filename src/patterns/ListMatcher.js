...
export class ListMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ListMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ListMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ListMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ListMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ListMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ListMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ListMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new ListMatcher(options);
  }
}
