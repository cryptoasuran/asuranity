...
export class GlobMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('GlobMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`GlobMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`GlobMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`GlobMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`GlobMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`GlobMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`GlobMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new GlobMatcher(options);
  }
}
