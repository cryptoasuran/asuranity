...
export class WildcardMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('WildcardMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`WildcardMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`WildcardMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`WildcardMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`WildcardMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`WildcardMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`WildcardMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new WildcardMatcher(options);
  }
}
