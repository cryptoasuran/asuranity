...
export class MACMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('MACMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`MACMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`MACMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`MACMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`MACMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`MACMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`MACMatcher error:`, error);
    }
  }
