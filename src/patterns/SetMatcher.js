...
export class SetMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('SetMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`SetMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`SetMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`SetMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`SetMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`SetMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`SetMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new SetMatcher(options);
  }
}

export default SetMatcher;
