...
export class ExactMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('ExactMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`ExactMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`ExactMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`ExactMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`ExactMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`ExactMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`ExactMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new ExactMatcher(options);
  }
}
