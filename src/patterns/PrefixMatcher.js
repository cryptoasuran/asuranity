...
export class PrefixMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PrefixMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PrefixMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PrefixMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PrefixMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PrefixMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PrefixMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`PrefixMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new PrefixMatcher(options);
  }
}
