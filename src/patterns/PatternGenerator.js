...
export class PatternGenerator extends EventEmitter {
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('PatternGenerator already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`PatternGenerator setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`PatternGenerator started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`PatternGenerator stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`PatternGenerator paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`PatternGenerator resumed`);
    }
  }
  ...
  static create(options) {
    return new PatternGenerator(options);
  }
}
