...
export class GraphMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('GraphMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`GraphMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`GraphMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`GraphMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`GraphMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`GraphMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`GraphMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new GraphMatcher(options);
  }
}

export default GraphMatcher;
