...
export class SuffixMatcher extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
      enabled: true,
  ...
  async initialize() {
    if (this.state.initialized) {
      throw new Error('SuffixMatcher already initialized');
    }
  ...
  async setup() {
    ...
    if (this.options.debug) {
      console.log(`SuffixMatcher setup complete`);
    }
  }
  ...
  handleStart() {
    if (this.options.debug) {
      console.log(`SuffixMatcher started`);
    }
  }

  handleStop() {
    if (this.options.debug) {
      console.log(`SuffixMatcher stopped`);
    }
  }

  handlePause() {
    if (this.options.debug) {
      console.log(`SuffixMatcher paused`);
    }
  }

  handleResume() {
    if (this.options.debug) {
      console.log(`SuffixMatcher resumed`);
    }
  }
  ...
  handleError(error) {
    ...
    if (this.options.debug) {
      console.error(`SuffixMatcher error:`, error);
    }
  }
  ...
  static create(options) {
    return new SuffixMatcher(options);
  }
}

export default SuffixMatcher;
