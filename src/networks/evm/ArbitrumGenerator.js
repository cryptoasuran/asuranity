...
export class ArbitrumGenerator {
  constructor(config = {}) {
    this.config = {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new ArbitrumGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new ArbitrumGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Arbitrum'] || 'https://etherscan.io';
  }
}

export default ArbitrumGenerator;
