...
export class CeloGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new CeloGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new CeloGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Celo'] || 'https://etherscan.io';
  }
}

export default CeloGenerator;
