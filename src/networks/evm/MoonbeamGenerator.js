...
export class MoonbeamGenerator {
  constructor(config = {}) {
    this.config = {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new MoonbeamGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new MoonbeamGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Moonbeam'] || 'https://etherscan.io';
  }
}

export default MoonbeamGenerator;
