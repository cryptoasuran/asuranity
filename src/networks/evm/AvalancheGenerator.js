...
export class AvalancheGenerator {
  constructor(config = {}) {
    this.config = {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new AvalancheGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new AvalancheGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Avalanche'] || 'https://etherscan.io';
  }
}

export default AvalancheGenerator;
