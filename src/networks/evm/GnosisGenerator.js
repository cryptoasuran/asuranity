...
export class GnosisGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new GnosisGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new GnosisGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Gnosis'] || 'https://etherscan.io';
  }
}

export default GnosisGenerator;
