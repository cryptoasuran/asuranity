...
export class OptimismGenerator {
  constructor(config = {}) {
    this.config = {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new OptimismGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new OptimismGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Optimism'] || 'https://etherscan.io';
  }
}

export default OptimismGenerator;
