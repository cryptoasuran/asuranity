...
export class EthereumGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new EthereumGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new EthereumGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Ethereum'] || 'https://etherscan.io';
  }
}
