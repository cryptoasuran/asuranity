...
export class CronosGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new CronosGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new CronosGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Cronos'] || 'https://etherscan.io';
  }
}

export default CronosGenerator;
