...
export class LineaGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new LineaGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new LineaGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Linea'] || 'https://etherscan.io';
  }
}

export default LineaGenerator;
