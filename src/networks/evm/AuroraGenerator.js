...
export class AuroraGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new AuroraGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new AuroraGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Aurora'] || 'https://etherscan.io';
  }
}

export default AuroraGenerator;
