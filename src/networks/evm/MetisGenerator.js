...
export class MetisGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new MetisGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new MetisGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Metis'] || 'https://etherscan.io';
  }
}

export default MetisGenerator;
