...
export class MantleGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new MantleGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new MantleGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Mantle'] || 'https://etherscan.io';
  }
}

export default MantleGenerator;
