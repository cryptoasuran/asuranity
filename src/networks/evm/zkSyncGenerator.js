...
export class zkSyncGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new zkSyncGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new zkSyncGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['zkSync'] || 'https://etherscan.io';
  }
}

export default zkSyncGenerator;
