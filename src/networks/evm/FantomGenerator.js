...
export class FantomGenerator {
  ...
  static async quickGenerate(pattern, options) {
    const generator = new FantomGenerator();
    return generator.generate(pattern, options);
  }

  static validateAddress(address) {
    return new FantomGenerator().validateAddress(address);
  }
  ...
  static getExplorer() {
    ...
    return explorers['Fantom'] || 'https://etherscan.io';
  }
}

export default FantomGenerator;
